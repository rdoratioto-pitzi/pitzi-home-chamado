...
export default function LoginPage() {
  ...
  // Erros vindos do callback OAuth Google
  useEffect(() => {
    ...
    const messages: Record<string, string> = {
      ...
      domain_not_allowed: "Apenas contas @pitzi.com.br são permitidas.",
      user_inactive: "Usuário inativo. Contate o administrador.",
      invalid_state: "Sessão expirada. Tente novamente.",
      token_exchange_failed: "Falha ao autenticar com Google. Tente novamente.",
      userinfo_failed: "Falha ao obter dados do Google. Tente novamente.",
    };
    toast({
      title: "Erro no login",
      description: messages[err] ?? "Erro desconhecido.",
      variant: "destructive",
    });
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mt-6 flex items-center gap-3">
            ...
            <span style={{ fontSize: "12px", color: "rgba(0,0,0,0.4)", fontFamily: "Montserrat, sans-serif" }}>ou</span>
            <div className="flex-1 h-px" style={{ background: "rgba(0,0,0,0.10)" }} />
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-4">
            <a
              ...
              className="flex items-center justify-center gap-3 w-full rounded-xl transition-colors duration-150"
              style={{
                height: "48px",
            ...
            >
              ...
              Entrar com Google (@pitzi.com.br)
            </a>
          </motion.div>
