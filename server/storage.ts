    ...
    const sampleLRPedidos: LogisticaReversaPedido[] = [
      {
        ...
        itensColeta: JSON.stringify([{ descricao: "Smartphone", quantidade: 1, valorUnitario: 1000, imei: "123" }]),
        tipoEmbalagem: "caixa",
        valorDeclarado: "1000",
        adicionalAnac: false,
        custoEstimado: "30",
      ...
      },
      {
        ...
        destinatarioUf: "SP",
        observacao: null,
        itensColeta: JSON.stringify([{ descricao: "Tablet", quantidade: 1, valorUnitario: 2000, imei: "456" }]),
        tipoEmbalagem: "caixa",
        valorDeclarado: "2000",
        adicionalAnac: false,
        custoEstimado: "40",
