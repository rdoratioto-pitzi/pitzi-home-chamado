...
## 📚 FEEDBACK E APRENDIZADOS (MAX AI)
O arquivo /docs/MAX-FEEDBACK.md contém aprendizados documentados de tasks anteriores do Max AI.

**Quando usar**:
- Antes de iniciar task complexa (renomeações, refatorações)
- Após cometer erro que gerou retrabalho
- Para consultar checklists de procedimentos

**Quando atualizar**:
- Sempre que Max cometer erro que exigiu correção manual
- Sempre que identificar novo padrão/aprendizado
- Após feedback do time sobre qualidade do código

**Regra**:
- Max deve **CONSULTAR** este arquivo antes de tasks similares
- Max deve **ATUALIZAR** este arquivo após erros identificados
- Todo erro documentado deve incluir:
  * O que aconteceu
  * Por que aconteceu
  * Como deveria ter sido feito
  * Checklist para evitar repetição
...
**Aprendizado:** [como evitar]
**Checklist:** [passos corretos]
```

**Exemplo**: Ver /docs/MAX-FEEDBACK.md seção &quot;03/03/2026 - Renomear Biblioteca&quot;
